...
# The independent variables specified in this requirement (4) is the same as those specified in requirement 1. Therefore, this data.frame is already build and normalized (To_Predict_norm).
